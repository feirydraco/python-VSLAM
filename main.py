...
# Allow camera to adjust exposusre
for _ in range(15):
...
try:
    while True:
        ...
        flow = cv2.calcOpticalFlowFarneback(
            prvs, frame_gray, None, 0.5, 3, 15, 3, 5, 1.2, 0)
        ...
        #     cv2.circle(color_image, (int(point[0]), int(point[1])),
        #                10, (0, 0, 255), thickness=10, lineType=8, shift=0)
        #     print(point, distance * 10 ** 3)
